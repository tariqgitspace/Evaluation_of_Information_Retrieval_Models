...
with open('queries_multiple_languages.txt', encoding="utf-8") as f:
    for line in f:
        ...
        weights = 'tweet_hashtags^1.12%20text_en^'+str(weight_en)+'%20text_de^'+str(weight_de)+'%20text_ru^'+str(weight_ru)
        ##weights = 'text_en^'+str(weight_en)+'%20text_de^'+str(weight_de)+'%20text_ru^'+str(weight_ru)
        pf = 'tweet_hashtags^1.0%20text_en^'+str(2*weight_en)+'%20text_de^'+str(2*weight_de)+'%20text_ru^'+str(2*weight_ru)
        ##print(weights)
